...
One envelope up close: its mode and cadence, and the math behind how much is left in it.
...
```
  Mode automatic · Cadence monthly
  Monthly 600 · Consumed 155 · Remaining 445

  Consumed rises with the calendar (auto)
  or with what you record (manual).
```
